	...
	<div class="bg-contact3" style="background-image: {{asset('Borrow/images/bg-01.jpg')}};">
		<div class="container-contact3">
			<div class="wrap-contact3">
				<form class="contact3-form insert-validate-form" action="{{action('ItemController@add')}}" method="post">
					<span class="contact3-form-title">
						Insert Barang SLC
					</span>

					<div class="wrap-input3 validate-input" data-validate="Id is required">
						<input class="input3" type="text" name="itemId" placeholder="Item Id">
